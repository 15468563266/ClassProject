...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="${pageContext.request.contextPath }/update"  class="form-horizontal"  method="post" >

			
			<div class="form-group">
			    <label for="subjectId" class="col-sm-2 control-label">标题</label>
			<div class="col-sm-10">
				<input type="text" value="${video.title}" name="title">
			  </div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" value="${video.detail}" name="detail">
				</div>
			  </div>
			...
			<div class="col-sm-10">
				<input type="text" value="${video.speaker_id}" name="speaker_id">
			  </div>
			  </div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				<input type="text" value="${video.time}" name="time">	
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				<input type="text" value="${video.play_num}" name="play_num">
				</div>
			</div> 
