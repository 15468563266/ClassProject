                        ...
                        <div class="profile_ifo_area">
                            <form>
                                ...
                                <div class="form_group">
                                    <span class="dd">昵　称：</span><input name="name" type="text" value="${user.nickname }">
                                
                                </div>
                                <div class="form_group">
                                    <span class="dd">性　别：</span>
                                   
                                    <input id="man"  type="radio"  name="sex" value="${user.sex }"><label for="man">男</label>
                                    <input id="woman" type="radio" name="sex" value="${user.sex }"><label for="woman">女</label>
