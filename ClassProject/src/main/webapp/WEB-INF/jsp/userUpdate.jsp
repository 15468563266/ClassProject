                        ...
                        <div class="profile_ifo_area">
                            <form action="userUpdate" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input id="woman" type="radio" name="sex" value="女" checked="checked">女
                                </div>
                                <div class="form_group">
