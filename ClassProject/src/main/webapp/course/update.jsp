...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="${pageContext.request.contextPath }/update2"  class="form-horizontal"  method="post" >

			
			<div class="form-group">
			    <label for="subjectId" class="col-sm-2 control-label">主题</label>
			<div class="col-sm-10">
				<input type="text" value="${course.course_title}" name="course_title">
			  </div>
			  </div>
			  
			  <div class="form-group">
				<label for="courseDesc" class="col-sm-2 control-label">介绍</label>
				<div class="col-sm-10">
					<input type="text" value="${course.course_desc}" name="course_desc">
				</div>
			  </div>
			...
			<div class="col-sm-10">
				<input type="text" value="${course.subject_id}" name="subject_id">
